...
title: "About"
url: "/about/"
summary: "Who I am and what I'm about"
showToc: false
---
...
By day I work at [Asana](https://asana.com). I'm the technical person embedded in the legal team — I build the tooling that makes legal work less painful. I got there the long way: I've worked in legal for years, taught myself to code on the side, and slowly turned "the guy who can write a script" into an actual job.
...
**0773H** — my little web3 media project: a newsletter, a podcast, and whatever else I feel like shipping. The name is calculator-speak. Type `07734` into a calculator and flip it over — it reads *hELLO*. I swapped the 4 for an H, because a 4 doesn't really look like an *h* upside down and a capital H does. It's dumb, it's short, the domain and ENS were free, and it flexes — 0773H Weekly, Daily, Spaces, whatever. I tweeted it out once and people replied in calculator language, so I figured it landed with my kind of people.

Lately most of my building energy goes into the [Nouns DAO](https://nouns.wtf) ecosystem — an onchain builder-reputation system, milestone-based contributor payments, a terminal client for governance, and a Prop Dates tool for Lil Nouns. The full list, with the technical details, lives on the [Projects](/projects/) page.

I'm on [Farcaster](https://warpcast.com/gramajo.eth) more than anywhere else, mostly because the stuff I write actually reaches people there. I'm interested in onchain publishing, agents that can act on governance without a human babysitting them, and — since Sora and everything after it — the problem of proving a message actually came from *you*. I keep coming back to the idea that a signature and a keypair get you most of the way there.
...
Beyond that: I grew up on streetwear (I still owe myself a proper deep-dive on The Hundreds or Murakami). I'm a gamer with a backlog I'll never clear — Titanfall 2 pulled me back in after The Last of Us made me put the controller down for a year. I read across the map, from Paul Johnson's *Creators* to comics like *Y: The Last Man*. I take photos ([more on that here](/photography/)). I got deep enough into birding that I wrote an eBird plugin for Obsidian. And I travel when I can — five weeks around Europe with a baby, San Sebastián, Montreal for the bagels and the coffee. Weekends usually have soccer on somewhere in the background.

---

## Around the web

- **GitHub:** [jgramajo4](https://github.com/jgramajo4)
- **Farcaster:** [@gramajo.eth](https://warpcast.com/gramajo.eth)
- **Substack (0773H):** [gramajo.substack.com](https://gramajo.substack.com/)
- **Podcast (Behind the Screen):** [pods.media/behind-the-screen](https://pods.media/behind-the-screen/)
- **Bluesky:** [@gramajo.bsky.social](https://bsky.app/profile/gramajo.bsky.social)
